    ...
    fileInput.addEventListener("change", () => {
        ...
        if (file) {
            ...
            if (file.type.startsWith("image/")) {
                ...
                <img src="${fileURL}" alt="Uploaded Image" class="uploaded-image-preview" style="max-width: 100px; max-height: 100px; ">
            ...
            `;
                // Apply inline style to remove padding
    ...
    textArea.addEventListener("keydown", (event) => {
        if (event.key === "Enter" && !event.shiftKey) {
            // Avoid triggering if Shift+Enter is used
