            ...
            <div class="left-part-ofcode">
                <div class="form-container">
                    <form>
                        ...
                        <label for="image-analysis-type">Analysis Type</label>
                        <select id="image-analysis-type" name="image_analysis_type">
                            <option value="description" selected>Image Description</option>
            ...
            <div class="analysis-container" >
                <div class="icon-chat">
                    <div class="underpages" style='font-size:14px;margin-bottom: 0;'>
                        <p>analyze your images and start chat with it.</p>
                    </div>
                ...
                <div class="welcome">
                    <h4 class="welcome-msg">Chat with your images</h4>
                </div>
