      ...
      <div class="card-sign-form">
        <div class="frame">
          ...
          <form id="login-form" method="POST" action="{{ route('register') }}">
            ...
            <div class="frame-2">
                ...
                <div class="form-control">
                    <div class="input-filled-new">
                        <input type="text" id="name" name='name' class="text-wrapper-4" placeholder="Full name" />
                    </div>
                </div>

                <div class="form-control">
                  <div class="input-filled-new">
                    <input type="email" id="email" name='email' class="text-wrapper-4" placeholder="E-mail address" />
                  </div>
                </div>
                ...
                <div class="form-control">
                  <div class="password">
                    <div class="input-filled-new">
                        <input type="password" id="password" class="text-wrapper-4" name='password' placeholder="Password" required min='8'/>
            ...
            <button id='submit-btn' type="submit" class="submit" disabled='disabled'>Sign Up</button>
        </form>
          ...
          <div class="bottom">
            ...
            <a href="{{ route('login') }}" class="hyperlink">Sign In</a>
          </div>
        </div>
      </div>
    </section>

    <script src="{{ asset('assets/js/signup.js') }}" defer></script>
    <script>
        ...
        const validateForm = () => {
            ...
            submitButton.disabled = !(email && name.length >= 4 && password.length >= 8 && emailRegex.test(email));
        };
